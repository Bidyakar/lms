...
include('dbcon.php'); // contains $conn (mysqli connection)
?>
        ...
        <div class="row">	
            <div class="span12">	
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered" id="example">
                    ...
                    <?php
                    // Fetch damage books
                    $stmt = $conn->prepare("SELECT * FROM book WHERE status = ?");
                    $status = 'Damage';
                    ...
                    ?>
                        <tr class="del<?php echo htmlspecialchars($id); ?>">
                            ...
                            <td class="action">
                                <div class="span2">
                                    <a rel="tooltip" title="Delete" id="<?php echo htmlspecialchars($id); ?>" href="#delete_book<?php echo htmlspecialchars($id); ?>" data-toggle="modal" class="btn-default">
                                        <i class="icon-trash icon-large"></i>
                                    </a>
                                    <?php include('delete_book_modal.php'); ?>
                                    <div class="span1">
                                        <a rel="tooltip" title="Edit" id="e<?php echo htmlspecialchars($id); ?>" href="edit_book.php?id=<?php echo htmlspecialchars($id); ?>" class="btn-default">
