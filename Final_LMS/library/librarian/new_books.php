...
include('dbcon.php'); // make sure this sets up $conn with mysqli

// Fetch new books with category in one query
  ...
  <div class="margin-top">
    <div class="row">  
      <div class="span12">  
        ...
        <center class="title"><h1>New Books</h1></center>
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered" id="example">
          ...
          <tbody>
            ...
            if($result && $result->num_rows > 0) {
              ...
              echo '<tr><td colspan="11" class="text-center">No new books found.</td></tr>';
            }
            ?>
          </tbody>
        </table>
